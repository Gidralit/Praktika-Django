    ...
    *un*available to the created environment.
    ...
    def replace_variables(self, text, context):
        ...
        :param context: The information for the environment creation request
                        being processed.
        """
        text = text.replace('C:\Users\public.COPP\PycharmProjects\praktika\venv', context.env_dir)
        text = text.replace('venv', context.env_name)
        text = text.replace('(venv) ', context.prompt)
        text = text.replace('Scripts', context.bin_name)
        text = text.replace('C:\Users\public.COPP\PycharmProjects\praktika\venv\Scripts\python.exe', context.env_exe)
        return text
